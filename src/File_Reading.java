...
class Data{
	...
	public Data(){
		this.date = ""; this.time = ""; this.sale = ""; this.rating = ""; this.amount = ""; this.issue = "";
		this.pop1 =""; this.pop2 = ""; this.assessVal1 = ""; this.assessVal2 = ""; this.market_perc = ""; 
		this.netDir1 = ""; this.overallDebt = ""; this.overallPC = ""; this.overallAV = ""; this.overallMV = ""; 
		this.comment = "";
	}
}
...
//		 System.out.println("comment is "+comment);
	...
	public static void fillDebtData(Data data, int line, String value){
		if(line == 1){
			...
			data.overallDebt = value;
			
		}
		else if(line == 3){
			data.overallPC = value;
			
		}
		else if(line == 4){
			data.overallAV= value;
			
		}
		else if(line == 5){
			data.overallMV= value;
